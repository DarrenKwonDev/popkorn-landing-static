export default {
  "PopKorn makes": "지루한 한국어 공부는 그만!",
  "Korean language": "재밌게 배워보는",
  ...
  "Master your Korean.": "한국어를 재미있게 공부할 수 있습니다",
  Discover: "바로가기",
  // 특징
  Features: "팝콘이 제공하는 기능",
  "EduPopKorn’s Mission expands beyond education.":
    "EduPopKorn의 미션은 교육을 교육 이상의 것으로 만드는 것입니다.",
  "Find your K-Pop Stars,": "당신의 Kpop 스타,",
  "favorite dramas and movies.": "좋아하는 드라마, 영화를 찾아보세요",
  "Watch the videos with subtitles.": "자막과 함께 비디오를 보세요",
  "Solve quick quizzes about the video!": "비디오에 대한 퀴즈를 풀어보세요!",

  "Fix your pronounciation": "AI TTS-STT 서비스를 통해",
  "with EdupopKorn TTS AI service.": "한국어 발음을 교정할 수 있습니다.",

  "Watch lectures provided by": "훌륭한 강사진이 제공하는",
  "our selected educators.": "양질의 강의를 수강할 수 있습니다.",

  //후기
  Testimonials: "테스터 후기",
  "Great and fun experience! I really enjoyed using it! It really helps me improve Korean language.":
    "재미있는 경험이었습니다! 완전 즐기면서 했어요. 또 한국어 배우는데 좋기도 하구요",
  "I studied Korean language for several years and popkorn turned out to be the best. I will definitely recommand":
    "사실 저는 한국어를 몇년 동안 공부해왔습니다. 결국 팝콘이 제일 좋은 것 같아요. 강추합니다!",
  "Easy way to learn Korean language. I found Korean to be really challenging but Popkorn changed my mind!":
    "한국어를 배우는 가장 쉬운 방법입니다. 한국어는 배우기 정말 어려운 언어인데 팝콘이 이런 제 생각을 바꿨습니다.",
  "I love Kpop and I love Kdramas. Now I love Popkorn too! I think I will continue using this application.":
    "저는 케이팝과 드라마를 좋아해요. 이제는 팝콘도 좋아합니다! 아마 계속 사용하게 될 것 같아요",
  //about"
  "EduPopKorn is on a mission": "EduPopKorn의 미션은",
  "to make Korean language": "한국어 학습을 쉽고",
  "fun and exciting": "재미있게 만드는 것입니다.",
